...
INSERT INTO Tickets (dataAbertura, dataFechamento, titulo, descricao, status, tipoTecnico, categoriaID, equipamentosID, salaID, usuarioID)
VALUES 
('2024-04-20 10:00:00', NULL, 'Problema de Conexão', 'Usuário relatou problemas de conexão à internet.', 'A', '1', 3, 4, 1, 1),
('2024-04-21 09:30:00', NULL, 'Problema com Impressora', 'Impressora não está imprimindo.', 'A', '2', 1, 4, 2, 2),
('2024-04-21 11:15:00', NULL, 'Solicitação de Licença', 'Usuário solicita licença para software específico.', 'A', '3', 2, 5, 3, 3);