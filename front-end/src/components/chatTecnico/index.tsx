        ...
        <>
            ...
            <div className='containerMensagemChat'>
                {anotacoes.map((message, index) => (
                    message.usuario.tipoUsuario.includes('1') || message.usuario.tipoUsuario.includes('2') || message.usuario.tipoUsuario.includes('3') || message.usuario.tipoUsuario.includes('A') ? (
