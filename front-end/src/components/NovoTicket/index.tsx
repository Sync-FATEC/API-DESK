...
export const NovoTicket = () => {
    ...
    return (
        <div className="modalTicket">
            <h1>Novo Ticket</h1>
            <form className='containerNovoTicket' onSubmit={handleSubmit}>
                ...
                <div className="formTicket">
                    <input value={titulo} onChange={handleAssunto} className='inputCategoria' type="text" placeholder="Titulo do Ticket" />
                    <div>{assuntoError}</div>
                </div>
                <div className="formTicket">
                    <textarea value={descricao} onChange={handleDescricao} className='inputCategoria' placeholder="Descrição do Ticket"></textarea>
